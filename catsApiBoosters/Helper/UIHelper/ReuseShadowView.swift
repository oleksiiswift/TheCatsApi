...
class ReuseShadowView: UIView {
	...
	public var cellBackgroundColor: UIColor = Theme.cellBackGroundColor
	public var topShadowColor: UIColor = Theme.topShadowColor
	public var cellShadowColor: UIColor = Theme.sideShadowColor
